...
//  EtpKit
//
//  Created by Emin Tolgahan Polat on 10.04.2020.
...
@objc public protocol  ViewPagerDataSource {
    ...
    func viewAtIndex(viewPager:UIViewPager, index:Int, view:UIView?) -> UIView
    @objc optional func didSelectedItem(index:Int)
    
}

@IBDesignable
public class UIViewPager: UICollectionReusableView {
...
extension UIViewPager:UIScrollViewDelegate{
...
extension UIViewPager{
    
    
    func animationNext(){
        Timer.scheduledTimer(timeInterval: 2, target: self, selector: #selector(UIViewPager.moveToNextPage), userInfo: nil, repeats: true)
    }
