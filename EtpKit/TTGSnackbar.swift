...
open class TTGSnackbar: UIView {
    ...
    @objc open dynamic var topMargin: CGFloat = 14 {
        didSet {
    ...
    @objc open dynamic var bottomMargin: CGFloat = 14 {
        didSet {
    ...
    @objc open dynamic var leftMargin: CGFloat = 14 {
        didSet {
    ...
    @objc open dynamic var rightMargin: CGFloat = 14 {
        didSet {
...
public extension TTGSnackbar {
    ...
    @objc func show() {
        ...
        separateView.isHidden = true //actionButton.isHidden
